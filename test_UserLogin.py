    ...
    def test_login_002(self, setup):
        ...
        if self.rp.Status() == True:
            self.driver.save_screenshot(
                "C:\\Users\\admin\\OneDrive\\Desktop\\Automation_CredCart\\Screenshots\\test_login_001_pass.png")
            assert True
        else:
            self.driver.save_screenshot(
                "C:\\Users\\admin\\OneDrive\\Desktop\\Automation_CredCart\\Screenshots\\test_login_001_fail.png")
            assert False
        self.driver.close()