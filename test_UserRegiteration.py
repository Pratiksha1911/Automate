...
from pageObject.UserRegisterationPage import UserRegistrationClass
...
class Test_registration:
    ...
    def test_registration_001(self,setup):
        ...
        self.rp.Enter_Email("pppb@credence.in")
        ...
        if self.rp.Status() == True:
            self.driver.save_screenshot(
                "C:\\Users\\admin\\OneDrive\\Desktop\\Automation_CredCart\\Screenshots\\test_registration_001_pass.png")
            assert True
        else:
            self.driver.save_screenshot(
                "C:\\Users\\admin\\OneDrive\\Desktop\\Automation_CredCart\\Screenshots\\test_registration_001_fail.png")
            assert False
        self.driver.close()
